...
#
# 1. Go to the `segment-anything repo <checkpoint https://github.com/facebookresearch/segment-anything/tree/main#model-checkpoints>`_ and
# download the ``vit_h`` checkpoint. Alternatively, you can just use ``wget``:
...
sam_path = "/home/yliu7/workspace/sam"
