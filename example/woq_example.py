...
1) W8A8(need H100): torch._scaled_mm
2) W4A16, dequant weight to float, then use `torch.nn.functional.linear`

3. [MXFP8]
对于MXFP8, dequant weight to float, then use `torch.nn.functional.linear`
